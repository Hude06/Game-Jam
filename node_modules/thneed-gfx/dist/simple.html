...
})({"cwghM":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "c2727b3c7db86b48";
...
},{}],"cLDMT":[function(require,module,exports) {
var _simpleTs = require("./simple.ts");
(0, _simpleTs.start)();

},{"./simple.ts":"831aN"}],"831aN":[function(require,module,exports) {
...
function start() {
    ...
    root.add(new (0, _src.ActionButton)());
    root.add(new (0, _src.DebugLayer)());
...
},{"./core":"6Wpln","./containers":"kfq5H","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cwghM","cLDMT"], "cLDMT", "parcelRequirec94a")
